...
/*
 * Forras: Dr. Szirmay-Kalos L·szlÛ, Antal Gyˆrgy, Csonka Ferenc:
 * H·romdimenziÛs grafika, anim·ciÛ Ès j·tÈkfejlesztÈs, 318. old.
...
void onKeyboard(unsigned char key, int x, int y) {
    ...
    if (key == 'R') {
        ...
        // Kisz·moljuk az ˙j forgat·si tengelyt, Vector(1, 0, 0) azt jelenti hogy x tengelyen szeretnÈnk forgatni
        // ez lÈnyegÈben egy tengely transzform·ciÛ, megadja hogy melyik tengelyek mentÈn kell forgassunk, hogy
        // x tengely mentÈn forogjon a heli ... ha y mentÈn szeretnÈnk forgatni akkor Vector(0, 1, 0) ha z akkor Vector(0, 0, 1)
